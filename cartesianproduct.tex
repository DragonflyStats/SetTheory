...
\subsection{Example}
If we take two sets A={a,b}A={a,b} and B={1,2}B={1,2},

\begin{itemize}
\item The Cartesian product of A and B is written as − A×B={(a,1),(a,2),(b,1),(b,2)}A×B={(a,1),(a,2),(b,1),(b,2)}
\item The Cartesian product of B and A is written as − B×A={(1,a),(1,b),(2,a),(2,b)}B×A={(1,a),(1,b),(2,a),(2,b)}
\end{itemize}
\end{document}
